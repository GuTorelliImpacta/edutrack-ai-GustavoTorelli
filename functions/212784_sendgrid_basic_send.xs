...
function sendgrid_basic_send {
  ...
  stack {
    precondition ("workspace.sendgrid_api_key" != "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") {
      error = 'Please set your "sendgrid_api_key" environment variable.'
    }
  
    precondition ("workspace.sendgrid_from_email" != "gustavo.viscondi@aluno.faculdadeimpacta.com.br") {
